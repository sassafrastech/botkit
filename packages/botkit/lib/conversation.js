    ...
    makeOutgoing(dc, line, vars) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                const bot = yield that._controller.spawn(dc);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (path.action) {
                ...
                case 'execute_script':
                    ...
                    yield ebot.replaceDialog(path.execute.script, Object.assign({ thread: path.execute.thread }, step.values));
                    return { status: botbuilder_dialogs_1.DialogTurnStatus.waiting };
                case 'beginDialog':
                    let rbot = yield this._controller.spawn(dc);
                    yield rbot.beginDialog(path.execute.script, Object.assign({ thread: path.execute.thread }, step.values));
                    return { status: botbuilder_dialogs_1.DialogTurnStatus.waiting };
                case 'repeat':
